...
describe("ResponsiveContainer", () => {
    ...
    it('passes the correct dimensions to the child component', () => {
        ...
        jest.spyOn(global, 'ResizeObserver').mockImplementation((callback: ResizeObserverCallback) => {
    ...
    it('applies min and max dimensions correctly', () => {
        ...
        render(
            <ResponsiveContainer minDimensions={{ width: 200, height: 100 }} maxDimensions={{ width: 800, height: 600 }}>
                <MockChart width={0} height={0} />
            </ResponsiveContainer>
        );
    ...
    it('applies padding correctly', () => {
        ...
        render(
            <ResponsiveContainer padding={{ top: 10, right: 20, bottom: 30, left: 40 }}>
                <MockChart width={0} height={0} />
            </ResponsiveContainer>
        );
    ...
    it('renders error fallback when child throws', () => {
        ...
        render(
            <ResponsiveContainer errorFallback={<div data-testid="error-fallback">:(</div>}>
                <ErrorComponent />
            </ResponsiveContainer>
        );
