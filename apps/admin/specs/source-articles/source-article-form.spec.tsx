...
import SourceArticleForm from '@/app/source-articles/create/page';
import { useSourceArticleForm } from '@/app/source-articles/create/use-source-article-form';
import { useForm } from 'react-hook-form';
import { useUser } from '@/lib/get-user';
import { FormValues } from '@/app/source-articles/create/form-types';
import { Conference, Division } from '@/types';

jest.mock('@/app/source-articles/create/use-source-article-form');
