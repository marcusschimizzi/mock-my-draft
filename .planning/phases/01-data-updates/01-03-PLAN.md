...
must_haves:
  truths:
    - 'Admin dashboard shows the latest data import status and last updated timestamp.'
    - 'Admin can trigger a manual import from the dashboard and see the updated status.'
  artifacts:
